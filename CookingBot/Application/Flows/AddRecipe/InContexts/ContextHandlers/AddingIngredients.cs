    ...
    : ContextHandler<RecipePayload, AddingRecipeContext>
{
        ...
        DetailContext<RecipePayload, AddingRecipeContext> context)
    {
        ...
        var parsedText = request.AsIngredient();
        ...
        {
            await botClient.SendTextMessageAsync(context.ChatId, "Ты это уже добавил или что-то пошло не так");
            return;
        }


        await botClient.SendTextMessageAsync(context.ChatId, "Добавил. Можешь добавить еще",
